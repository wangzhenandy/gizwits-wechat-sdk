...
Connection.prototype._onWSMessage = function(evt)
{
    ...
    switch(res.cmd)
    {
        ...
        case "login_res":
            ...
            {
                conn._callbackObj._sendError("Login failed, It will try again, please wait...");
                conn._tryLoginAgain();
            }
            break;
        case "subscribe_res":
            ...
            {
                conn._removeSubDevice(failedDids[j].did);
        ...
        case "s2c_invalid_msg":
            ...
            {
                conn._callbackObj._sendError(res.data.msg);
            }
            break;
    }
};
...
{
    var conn = this;
    var keepalive = conn._callbackObj._keepaliveTime * 1000;
...
Connection.prototype._removeSubDevice = function(did)
{
    var conn = this;
    var subDids = conn._subDids;
    for (var i = 0; i < subDids.length; i++)
